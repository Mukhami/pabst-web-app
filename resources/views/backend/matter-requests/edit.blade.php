    ...
    <div class="container-xl px-4 mt-n10">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('matter-requests.update', $matterRequest) }}" >
                    @csrf
                    @method('put')
                    <!-- Form Row  -->
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input required class="form-control @error('client_ref') is-invalid @enderror" id="client_ref" type="text" placeholder="Enter Client Ref" value="{{ old('client_ref', $matterRequest->client_ref) }}" name="client_ref"/>
                            @error('client_ref')
                            <div class="text-sm text-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input required class="form-control @error('client_secondary_contacts') is-invalid @enderror" id="client_secondary_contacts" type="text" placeholder="Enter Client Secondary Contact" value="{{ old('client_secondary_contacts', $matterRequest->client_secondary_contacts) }}" name="client_secondary_contacts"/>
                    ...
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input required class="form-control @error('conversion_date') is-invalid @enderror" id="conversion_date" type="date" placeholder="Enter Conversion Date" value="{{ old('conversion_date', $matterRequest->conversion_date) }}" name="conversion_date"/>
                    ...
                    <div class="row gx-3 mb-3">
                        <div class="col-md-4">
                            ...
                            <input required class="form-control @error('inventors') is-invalid @enderror" id="inventors" type="text" placeholder="Enter Investors" value="{{ old('inventors', $matterRequest->inventors) }}" name="inventors"/>
                            @error('inventors')
                            <div class="text-sm text-danger">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input required class="form-control @error('licensees') is-invalid @enderror" id="licensees" type="text" placeholder="Enter Licensee(s)" value="{{ old('licensees', $matterRequest->licensees) }}" name="licensees"/>
                            @error('licensees')
                            <div class="text-sm text-danger">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input required class="form-control @error('assignees') is-invalid @enderror" id="assignees" type="text" placeholder="Enter Assignee(s)" value="{{ old('assignees', $matterRequest->assignees) }}" name="assignees"/>
                            @error('assignees')
                            <div class="text-sm text-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="row gx-3 mb-3">
                        <div class="col-md-4">
                            ...
                            <input required class="form-control @error('co_owners') is-invalid @enderror" id="co_owners" type="text" placeholder="Enter Co-Owners" value="{{ old('co_owners', $matterRequest->co_owners) }}" name="co_owners"/>
                            @error('co_owners')
                            <div class="text-sm text-danger">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input required class="form-control @error('adverse_parties') is-invalid @enderror" id="adverse_parties" type="text" placeholder="Enter Adverse Party(ies)" value="{{ old('adverse_parties', $matterRequest->adverse_parties) }}" name="adverse_parties"/>
                        ...
                        <div class="col-md-4">
                            ...
                            <input required class="form-control @error('entity_size') is-invalid @enderror" id="entity_size" type="text" placeholder="Enter Entity Size" value="{{ old('entity_size', $matterRequest->entity_size) }}" name="entity_size"/>
                            @error('entity_size')
                            <div class="text-sm text-danger">
                                {{ $message }}
                            </div>
                    ...
                    @if(auth()->user()->hasRole('responsible_attorney'))
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-4">
                                <label class="small mb-1" for="docketing_user_id">{{__('Conflict User')}}</label>
