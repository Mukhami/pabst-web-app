...
@section('content')
    ...
    <div class="container-xl px-4 mt-n10">
        <div class="card mb-4">
            <div class="card-header">{{__('Create a New Matter Type')}}</div>
            <div class="card-body">
                <p class="text-muted">
                    {{__('Kindly fill in the form below to create a new Matter Type.')}}
                </p>
                <form method="post" action="{{ route('matter-types.store') }}" >
                    @csrf
                    <!-- Form Row  -->
